...
| `cta_clicked`            | Any homepage/navbar CTA button clicked      | location, label              |
...
- `@insforge/sdk` — InsForge client (use the `/ssr` and `/ssr/middleware` subpaths for Next.js SSR auth — see architecture.md)
